			...
			{publications.data.length > 0 && ( // Only show pagination if there are publications
                <div className="flex items-center justify-center gap-4 pt-12 pb-8">
                    <Button
                        ...
                        size="icon"
                        onClick={() =>
                            handlePaginationClick((paginationLinks.find((link) => link.label === "&laquo; Previous")?.url ?? null))
                        }
                    ...
                    <Button
                        ...
                        size="icon"
                        onClick={() =>
                            handlePaginationClick((paginationLinks.find((link) => link.label === "Next &raquo;")?.url ?? null))
                        }
