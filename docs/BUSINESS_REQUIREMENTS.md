...
To ensure content quality and consistency, the following workflow will be implemented for all publications:

1.  **Submission:** A Member submits a Publication, which enters the system with an `in_review` status.
